...
*/
    ...
    Route::post('/parent-list-ai', [ParentController::class, 'parent_list_ai']);

    Route::post('/parent-ByID', [ParentController::class, 'parent_ByID']);
    Route::post('/items-list-ai', [ParentController::class, 'items_list_ai']);
    Route::post('/student-list-ai', [ParentController::class, 'student_list_ai']);
...
Route::middleware(['auth:parent_api'])->group(function () {
    ...
    Route::post('/addons-updates', [ParentController::class, 'addons_updates']);
    ...
    Route::post('/parent/renew-subscription', [ParentController::class, 'renewSubscription']);
