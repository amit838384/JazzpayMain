...
<div class="row justify-content-center">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.aboutbannerupdate', $id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input type="text" class="form-control @error('title_one') is-invalid @enderror" id="title_one" name="title_one" value="{{$title_one;}}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                          <input type="text" class="form-control @error('title_two') is-invalid @enderror" id="title_two" name="title_two" value="{{$title_two;}}">
