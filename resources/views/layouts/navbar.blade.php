...
@endif
    <span class="logo-sm">
        <img src="https://jazzpay.dkddev.com/assets/jazzpaylogo1.jpg" alt="" style="max-width: 38px; height: auto;">
    </span>
    <span class="logo-lg">
        <img src="https://jazzpay.dkddev.com/assets/jazzpaylogo1.jpg" alt="" style="max-width: 96px; height: auto;">
    </span>
</a>
    ...
    <div id="scrollbar">
        <div class="container-fluid mt-4">
            ...
            <ul class="navbar-nav" id="navbar-nav">
				...
				@if(auth()->user()->role != 'cafeteriaadmin')
                <li class="nav-item">
                    <a href="{{ url('/admin') }}" class="nav-link menu-link" data-key="t-remix">
                ...
                @endcanany
                @canany(['create-school', 'edit-school', 'show-school'])
                <li class="nav-item">
                ...
                @endcanany
                @canany(['show-cafeteria', 'add-cafeteria', 'edit-cafeteria'])
                <li class="nav-item">
                ...
                @endcanany
                @canany(['show-menu', 'edit-menu', 'delete-menu'])
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown custom-menu {{ request()->is('admin/menu') || request()->is('admin/dish') || request()->is('admin/dish-category') || request()->is('admin/meal-category') || request()->is('admin/ingredients-category') || request()->is('admin/assign-user') || request()->is('admin/menu-addon') ? 'show' : '' }}" id="manage_cafeteria">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item {{(request()->is('admin/menu-addon')) ? 'active' : '' }}">
                                <a href="{{ route('admin.menu_addon') }}" class="nav-link" data-key="t-remix">Menu Addon</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown custom-menu {{ request()->is('admin/pre-orders') ? 'show' : '' }}" id="order_details">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.pfs_Service') }}" class="nav-link" data-key="t-remix">PFS orders</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.all_consumption') }}" class="nav-link" data-key="t-remix">Reports</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.all_sales') }}" class="nav-link" data-key="t-remix">Sales Report</a>
                            </li>
                            <li class="nav-item">
				...
				@canany(['mails'])
                <li class="nav-item">
                    <a href="{{ route('admin.mails.index') }}" class="nav-link menu-link" data-key="t-remix">
                        <i class="ri-mail-line"></i> <span data-key="t-mails">Mails</span>
                    </a>
                </li>
                @endcanany

				
                 @canany(['pay-for-service'])
                <li class="nav-item">
                    <a href="{{ route('admin.admin_payforservice') }}" class="nav-link menu-link" data-key="t-remix">
                        <i class="ri-service-line"></i> <span data-key="t-pfs">Pay for Service</span>
                    </a>
                </li>
                @endcanany
                 ...
                 @canany(['pay-for-service'])
                <li class="nav-item">
                    <a href="{{ route('admin.statistics.details') }}" class="nav-link menu-link" data-key="t-remix">
                        <i class="ri-bar-chart-line"></i> <span data-key="t-statistics">Statistics</span>
                    </a>
                </li>
                @endcanany
                ...
                @endcanany
                @canany(['sadaq-payment'])
                <li class="nav-item">
                    <a href="#" class="nav-link menu-link" data-key="t-remix">
                        <i class="ri-hand-heart-line"></i> <span data-key="t-sadaq">Sadaq Payment</span>
                    </a>
                </li>
                @endcanany

                @canany(['app-message', 'app-feedback'])
                <li class="nav-item">
                    <a href="{{ route('admin.alert_message') }}" class="nav-link menu-link" data-key="t-remix">
                        <i class="ri-message-2-line"></i> <span data-key="t-app-message">App Message</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.app_feedback') }}" class="nav-link menu-link" data-key="t-remix">
                        <i class="ri-feedback-line"></i> <span data-key="t-feedback">Feedback</span>
                    </a>
                </li>
                @endcanany
                @auth
               ...
               @if(auth()->user()->role == 'cafeteriaadmin')
                    <li class="nav-item">
                        <a href="{{ route('admin.cafeteria_students') }}" class="nav-link menu-link" data-key="t-remix">
                            <i class="ri-team-line"></i> <span data-key="t-students">Students</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.cafeteria_onsite') }}" class="nav-link menu-link" data-key="t-remix">
                            <i class="ri-store-2-line"></i> <span data-key="t-pos">POS (Onsite)</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.cafeteria_pre_orders') }}" class="nav-link menu-link" data-key="t-remix">
                            <i class="ri-file-list-3-line"></i> <span data-key="t-preorders">Pre-Orders</span>
                        </a>
                    </li>
                    {{-- <li class="nav-item">
                        <a href="#" class="nav-link menu-link" data-key="t-remix">
                            <i class="ri-service-line"></i> <span data-key="t-pfs">PFS-orders</span>
                        </a>
                    </li> --}}

                    <li class="nav-item">
                        <a href="{{ route('admin.cafeteria_topuplist') }}" class="nav-link menu-link" data-key="t-remix">
                            <i class="ri-wallet-3-line"></i> <span data-key="t-topup">Cafe Topup</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{ route('admin.cafeteria_cards') }}" class="nav-link menu-link" data-key="t-remix">
                            <i class="ri-bank-card-line"></i> <span data-key="t-cards">Cards</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{ route('admin.cafeteria_Plans_list') }}" class="nav-link menu-link" data-key="t-remix">
                            <i class="ri-calendar-check-line"></i> <span data-key="t-plans">Subscription Plans</span>
                        </a>
                    </li>
                @endif
