...
<div class="row mb-2">
    <div class="col-12">
        <div class="p-1 rounded text-white w-25" style="background-color: #28a745;">
            <strong>Wallet Balance:</strong> QAR <span id="walletBalance">0</span>
        </div>
    </div>
</div>
...
<div class="row mb-2 mt-3">
    <div class="col-6"><strong>Date:</strong> {{ now()->format('d-M-Y') }}</div>
    <div class="col-6 text-end"><strong>Daily Limit:</strong> QAR <span id="spendLimit">0</span></div>
</div>

<div class="row mb-2">
    <div class="col-6"><strong>Parent Balance:</strong> QAR <span id="parentBalance">0</span></div>
    <div class="col-6 text-end"><strong>Parent Name:</strong> <span id="parentName">-</span></div>
</div>

<div class="row mb-2">
    <div class="col-6"><strong>Number:</strong> <span id="parentNumber">-</span></div>
</div>


<div class="row mb-2" id="allergyRow" style="display:none;">
    <div class="col-6"><strong>Allergies :</strong> <span id="restrictedfood">-</span></div>
</div>
