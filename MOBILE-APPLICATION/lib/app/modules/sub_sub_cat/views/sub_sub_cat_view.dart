...
class SubSubCatView extends GetView<SubSubCatController> {
  const SubSubCatView({super.key});
  @override
  Widget build(BuildContext context) {
    return GetBuilder<SubSubCatController>(builder: (logic) {
      return Scaffold(
  ...
  _subCatWidget(SubSubCatController logic, Map subCat) {
